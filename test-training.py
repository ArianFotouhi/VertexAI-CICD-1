...
bucket_name = 'clfunctions002'
storage_client = storage.Client(credentials=credentials, project=service_info['project_id'])
...
df = load_data(f'gs://{bucket_name}/bike-share/hour.csv')
